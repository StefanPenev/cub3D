...
/*   Updated: 2025/01/28 16:04:04 by anilchen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     {
//         if (ray_dir_x > 0)
//             selected_texture_path = ctrl->game->west_texture.frames[frame_index];
//         else
//             selected_texture_path = ctrl->game->east_texture.frames[frame_index];
//     }
//     else
//     {
//         if (ray_dir_y > 0)
//            selected_texture_path = ctrl->game->south_texture.frames[frame_index];
//         else
//           selected_texture_path = ctrl->game->north_texture.frames[frame_index];
//     }
//     selected_texture.img = mlx_xpm_file_to_image(ctrl->game->mlx,
//        selected_texture_path, &tex_width, &tex_height);
//     if (!selected_texture.img)
//     {
//         fprintf(stderr, "Failed to load texture: %s\n",
//	selected_texture_path);
//         return ;
//     }
//     selected_texture.addr = mlx_get_data_addr(selected_texture.img,
//         &selected_texture.bits_per_pixel, &selected_texture.line_length,
//         &selected_texture.endian);
// 	step = 1.0f * TEX_HEIGHT / wall_height;
// 	tex_pos = (draw_start - HEIGHT / 2 + wall_height / 2) * step;
// 	for (int y = draw_start; y < draw_end; y++)
// 	{
...
// 	for (int y = draw_end; y < HEIGHT; y++)
// 		put_pixel(screen_column, y, ctrl->game->floor_color, ctrl->game);
//      mlx_destroy_image(ctrl->game->mlx, selected_texture.img);
// }
